                ...
                <DefaultSection>
                    <div className='header'>
                        ...
                        <div className="arrows">
                            <img alt='prev' src='/img/small-arrow.svg' className="arrow prev" ref={navigationPrevRef} />
                            <img alt='prev' src='/img/small-arrow.svg' className="arrow next" ref={navigationNextRef} />
                        </div>
                    </div>
                    <div className="cards">
                        <Swiper
